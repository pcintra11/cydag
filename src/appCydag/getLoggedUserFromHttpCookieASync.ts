...
export const GetLoggedUserFromHttpCookieASync = async (point: string) => {
  ...
  try {
    ...
    //dbgError('GetLoggedUserFromHttpCookieASync', error.message); // mostra tb para o usuário comum, pois se for problema de APIs não liberadas no server nem o log será gravado
