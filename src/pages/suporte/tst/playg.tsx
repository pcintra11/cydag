...
import { Btn, FakeLink, BtnLine } from '../../../components';
...
class FrmDataApiCalls {
  ...
  sleepMs: string;
  qtd: string;
  forceErrPswMail: string; // psw errada (numero da ocorrencia para gerar o erro)
...
export default function PagePlayg() {
  ...
  const frmApiCalls = useFrm<FrmDataApiCalls>({
    defaultValues: {
      ...FrmDefaultValues(new FrmDataApiCalls()),
      ...{ tipoExec: 'n', toDo: 'md', qtd: '1', sleepMs: '4000', serverMsg: false } as FrmDataApiCalls,
    }
  });
