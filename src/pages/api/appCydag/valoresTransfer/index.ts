...
import { ProcessoOrcamentario, User, ValoresTransfer } from '../../../../appCydag/modelTypes';
    ...
    try {
      ...
      if (parm.cmd == CmdApi.initialization) {
        ...
        if (parm.cmd == CmdApi.valoresGet) {
          ...
          const valoresTransfer = await ValoresTransferModel.find(filterDb).sort({ localidadeDestino: 1 });
