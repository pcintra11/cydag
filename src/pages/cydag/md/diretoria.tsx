...
import { Entity_Crud, CmdApi_Crud as CmdApi, crudValidations } from '../../api/appCydag/diretoria/types';
...
const apis = { crud: (parm) => CallApiCliASync<any>(apisApp.diretoria.apiPath, parm) };
